...
export const ENTRY: BenchmarkEntry = {
  ...
  oneLiner: '200 道「看着简单、模型却翻车」的常识陷阱题',
  what:
  ...
  facts: [
    { label: '题量', value: '200+ 多选题' },
    { label: '三大类', value: '时空推理 / 社会智力 / 语言陷阱' },
    { label: '人类基线', value: '83.7%（9 人小样本）' },
    { label: '发布时最强', value: 'o1-preview 41.7%（2024-10）' },
    { label: '更新', value: '官网 simple-bench.com 持续更新榜单' },
  ],
  frontier: {
    value: 81.9,
  ...
  history: [
    { date: '2024-10-31', event: 'arXiv:2410.07359 发布，200+ 题' },
    { date: '2024-10', event: '发布时最强 o1-preview 41.7%，人类基线 83.7%，差距超 40 个点' },
    { date: '2026-08', event: '官网最强 Claude Fable 81.9%，仍未稳过人类线' },
  ],
  funFact:
    '「摩西带几只动物上方舟」这类陷阱题，把 2024 年最强的 o1-preview 考到只有 41.7%，而 9 个普通人类平均 83.7%——这是少数「人赢机器」还能量化说事的榜。',
  // 分数天梯：2026-08-14 核验。官网 simple-bench.com 榜（AVG@5，2026-08），
  // 人类基线 83.7%（9 人小样本），最高人类分 95.4%；榜首仍未稳过人类基线。
  ladder: [
    { model: 'Claude Fable', score: '81.9%', note: '官网榜（AVG@5），2026-08' },
    { model: 'Claude Opus 5', score: '80.6%', note: '官网榜，2026-08' },
    { model: 'Gemini 3.1 Pro Preview', score: '79.6%', note: '官网榜，2026-08' },
    { model: 'GPT-5.5 Pro', score: '76.9%', note: '官网榜，2026-08' },
    { model: 'Gemini 3.5 Flash', score: '76.7%', note: '官网榜，2026-08' },
    { model: 'Grok 4.6', score: '75.9%', note: '官网榜，2026-08' },
    { model: 'GPT-5.6 Sol Pro (xhigh)', score: '71.7%', note: '官网榜，2026-08' },
    { model: '人类基线', score: '83.7%', note: '官网基准（9 人小样本），最高人类分 95.4%' },
  ],
  traits: ['200+ 道常识陷阱题', '时空/社会/语言三类', '人类基线 83.7%', '官网持续更新', '固定题库可背'],
  openSource: {
    status: 'open',
