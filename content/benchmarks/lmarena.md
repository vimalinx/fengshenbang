...
traits:
  - 真实用户匿名对战盲投
  - 无固定题库，覆盖真实使用场景
  - Bradley-Terry 拟合 Elo + bootstrap 置信区间
  - 偏好榜：偏「好看」而非「正确」（啰嗦偏置）
  - 多子榜：文本/编程/视觉/WebDev/搜索等
facts:
  - label: 上线
    value: 2023-04，UC Berkeley LMSYS Org 推出 Chatbot Arena
  - label: 机制
    value: 匿名双模型同题对战，真实用户盲投（A 好/B 好/平局/都差）
  - label: 算法
    value: Bradley-Terry 模型拟合 Elo，bootstrap 置信区间
  - label: 数据规模
    value: 2025 年初官方论文统计已超 300 万票
  - label: 子榜
    value: 总榜/文本、编程、视觉、WebDev、搜索、文生图等
  - label: 现状
    value: 2026-01 更名 Arena，A 轮后估值 $1.7B
frontier:
  value: null
  note: >-
    Elo 是相对分，没有 0-100 口径，故 value 置空。参照点：2026-08 其编程子榜头部 Elo 约 1553（DataLearner
    镜像快照），前几名只差个位数；文本总榜头部长年咬合在几十分以内，而 Elo 差 100 分才约等于 64% 胜率。
openSource:
  status: partial
  url: https://huggingface.co/datasets/lmsys/chatbot_arena_conversations
  note: >-
    匿名对战数据集在 HuggingFace 公开（lmsys/chatbot_arena_conversations，gated auto），方法论论文 arXiv:2403.04132
    公开；但平台本身与实时投票数据为 Arena Intelligence 专有
history:
  - date: 2023-04
    event: UC Berkeley LMSYS Org 上线 Chatbot Arena，首创大规模匿名对战盲投
  - date: 2024-03
    event: 论文 arXiv:2403.04132 发表，确立 Bradley-Terry + 置信区间方法论
  - date: 2024-09
    event: 独立站点 lmarena.ai 上线，脱离 LMSYS 博客形态
  - date: 2025-04
    event: 分拆为公司 Arena Intelligence Inc.
  - date: 2025-05
    event: 获 $100M 种子轮融资
  - date: 2026-01
    event: 获 $150M A 轮（估值 $1.7B），01-28 正式更名「Arena」（arena.ai）
ladder:
  - model: Claude Fable 5
    score: "1506"
    note: 官方榜 2026-08（arena.ai 文本总榜 Elo）
