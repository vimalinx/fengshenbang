...
traits:
  ...
  - 无源码、禁联网
  - fuzzing 生成隐藏行为测试
  - 200 任务含 SQLite/FFmpeg 量级
  - 全体模型 resolved 率仍接近 0
facts:
  - label: 发布方
    value: Meta（John Yang、Ofir Press 等，含 SWE-bench 核心作者）
  - label: 发布时间
    value: 2026-05（arXiv:2605.03546）
  - label: 任务规模
    value: 200 个，从小 CLI 工具到 FFmpeg、SQLite、PHP 解释器
  - label: 任务形态
    value: 洁净室重建：给可执行文件+文档，无源码、禁联网
  - label: 判分方式
    value: agent 驱动 fuzzing 生成的隐藏行为测试套件比对
  - label: 官方 harness
...
history:
  - date: "2026-05-05"
    event: arXiv v1 发布，提出洁净室重建式评测，200 任务
  - date: 2026-05
    event: Kimi K3 发布材料引用「Program Bench」成绩，此榜进入主流视野
  - date: "2026-05-08"
    event: LessWrong 热帖「Is ProgramBench Impossible?」讨论其全体 0% 现象
  - date: 2026-08
    event: BenchLM 等第三方榜站收录，开始追踪各家 fully/almost-resolved 成绩
ladder:
  - model: Claude Opus 5
    score: 4.5%
    note: 官方 extended 榜 resolved（另有 37.0% almost-resolved），2026-08-10 更新
  - model: GPT-5.6 Sol
    score: 1.0%
    note: 官方 extended 榜 resolved（15.5% almost），2026-08-10 更新
  - model: GPT-5.5
    score: 0.5%
    note: 官方 extended 榜 resolved（13.5% almost），2026-08-10 更新
  - model: Gemini 3.6 Flash
    score: 0.5%
    note: 官方 extended 榜 resolved（4.0% almost），2026-08-10 更新
  - model: Claude Opus 4.8
    score: 0%
    note: 官方 extended 榜（16.5% almost），2026-08-10 更新
  - model: GLM-5.2
    score: 0%
    note: 官方 extended 榜（8.5% almost），2026-08-10 更新
  - model: Claude Opus 4.7
    score: 0%
    note: 官方 extended 榜（4.5% almost），2026-08-10 更新
  - model: Gemini 3.5 Flash
    score: 0%
    note: 官方 extended 榜（3.0% almost），2026-08-10 更新
  - model: GPT-5.4
    score: 0%
    note: 官方 extended 榜（0% almost），2026-08-10 更新
