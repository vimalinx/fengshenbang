...
facts:
  - label: 主办方
    value: Artificial Analysis，独立第三方评测机构
  - label: 现行版本
    value: Intelligence Index v4.1.1，由 9 个评测合成
  - label: 权重
    value: Agents 34% / Coding 24% / 科学推理 24% / 综合 18%
  - label: 协议
    value: zero-shot、统一温度（推理模型 0.6）、pass@1 为主、部分评测重复 3-10 次
  - label: 精度
    value: 官方估计指数 95% 置信区间小于 ±1%
  - label: 配套
    value: 与价格、速度并列展示；另有 Agentic/Coding 等细分指数
frontier:
  value: 63
  note: >-
    Claude Opus 5 以 63.0 居首（2026-08 AA 榜快照，BenchLM 与 felloai 转述一致），第三名落后约 2.1 分；考虑官方 ±1% 的置信区间，2-3
    分以上的差距才算有把握。
openSource:
  status: partial
  url: https://artificialanalysis.ai/leaderboards/models
  note: >-
    榜单与指数方法论公开可查，但指数构成与权重由 Artificial Analysis 单方维护，部分底层评测（AA-LCR、AA-Omniscience）为 AA
    自建，完整数据与高级功能在付费墙后
history:
  - date: 2025 年中
    event: v3 时代：MMLU-Pro、GPQA、HLE、SciCode、AIME 等难度型基准合成，被多篇学术论文采用
  - date: "2026-01-06"
    event: v4.0 大改版：踢出 MMLU-Pro 等趋于饱和的老基准，纳入 Agentic 与真实工作类评测（VentureBeat 报道）
  - date: "2026-02-25"
    event: 方法论页更新至 v4.1.1：9 个评测，GDPval-AA v2 与 τ³-Banking 入列，Agents 权重升至 34%
  - date: 2026-08
    event: Claude Opus 5 以 63.0 领跑榜单
ladder:
  - model: Claude Opus 5 (max)
    score: "63"
    note: 官方榜 2026-08，榜首（官方 95% 置信区间 ±1%）
  - model: Claude Opus 5 (xhigh)
    score: "63"
    note: 官方榜 2026-08，并列第一
  ...
  - model: GPT-5.6 Sol (max)
    score: "61"
    note: 官方榜 2026-08；The AI Rankings 2026-08-13 同录 61
  - model: Grok 4.6 (high)
    score: "61"
    note: 官方榜 2026-08；2026-08-12 发布即并列第三梯队
  - model: Kimi K3 (max)
    score: "60"
    note: 官方榜 2026-08；开源权重模型最高
